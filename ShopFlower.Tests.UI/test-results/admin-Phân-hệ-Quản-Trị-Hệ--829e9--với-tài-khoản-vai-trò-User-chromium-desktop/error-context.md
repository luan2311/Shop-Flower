...
- Name: admin.spec.js >> Phân hệ Quản Trị Hệ Thống (Admin & Authorization Test Suite) >> ADM_01: Chặn truy cập trang Admin đối với tài khoản vai trò User
- Location: tests\admin.spec.js:5:3
