...
Received string:  "form-control form-control-lg"
Timeout: 5000ms

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('input[name="Email"]')
    14 × locator resolved to <input required="" type="email" name="Email" placeholder="Email" class="form-control form-control-lg"/>
       - unexpected value "form-control form-control-lg"

```

```yaml
- textbox "Email": autouser01gmail.com
```
