...
- Name: checkout.spec.js >> Phân hệ Giỏ Hàng & Thanh Toán (Checkout Test Suite) >> PAY_01: Xác thực trường Số điện thoại tự động lọc chữ cái
- Location: tests\checkout.spec.js:37:3
...
Call log:
  - waiting for locator('#SoDienThoai') to be visible
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e73]:
    ...
    - generic [ref=e76]:
      - generic: FXBCCJzYSgPZvP2oKMfzZz8hxRc9PYB3fQS5rVPiY1mwqKQk8shkEWoiuhjmaQBphsN88DMqoF4CxQTAniNAizGJKDu5oEp8mcTFSkCuXII1
