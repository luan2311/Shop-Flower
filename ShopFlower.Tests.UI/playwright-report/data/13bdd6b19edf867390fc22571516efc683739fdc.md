...
Locator: locator('.validation-summary-errors, .alert-danger, .validation-summary-errors li')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.validation-summary-errors, .alert-danger, .validation-summary-errors li')
...
- group:
  - textbox "Mật khẩu": WrongPassword123
- button "ĐĂNG NHẬP"
- text: Quên mật khẩu?
