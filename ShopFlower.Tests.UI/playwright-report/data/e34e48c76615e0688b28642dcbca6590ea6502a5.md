...
Locator: locator('.container h2, .unauthorized-text, .alert-warning').first()
Expected pattern: /Không có quyền|Từ chối truy cập|Unauthorized|Lỗi/
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.container h2, .unauthorized-text, .alert-warning').first()
...
- banner:
  ...
  - link "Tài khoản":
    - /url: /Admin
    - text: Thông tin user_1780239263050
  - link "Giỏ hàng":
    - /url: /Cart/Cart
    - img
    - text: 0 Giỏ hàng
