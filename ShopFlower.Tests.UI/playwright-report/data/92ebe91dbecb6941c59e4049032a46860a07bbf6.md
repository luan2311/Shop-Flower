...
- Name: auth.spec.js >> Phân hệ Đăng Ký & Đăng Nhập (Authentication Test Suite) >> REG_01: Đăng ký thành công và tự động trim khoảng trắng
...
- generic [ref=e1]:
  ...
  - generic [ref=e72]:
    ...
    - generic [ref=e75]:
      - group [ref=e76]:
        - textbox "Tên đăng nhập" [ref=e77]: auto_client_1780252631706
      - group [ref=e78]:
        - textbox "Email" [ref=e79]: autoclient_1780252631706@example.com
      - group [ref=e80]:
        - textbox "Tên hiển thị (không bắt buộc)" [ref=e81]: Khách hàng Tự động
      - group [ref=e82]:
        - textbox "Mật khẩu" [ref=e83]: SecurePass123!
      - group [ref=e84]:
        - textbox "Xác nhận mật khẩu" [active] [ref=e85]: SecurePass123!
      - generic [ref=e86]:
