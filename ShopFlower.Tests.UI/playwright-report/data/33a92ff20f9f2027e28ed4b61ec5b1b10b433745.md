...
- Name: auth.spec.js >> Phân hệ Đăng Ký & Đăng Nhập (Authentication Test Suite) >> LOG_01: Đăng nhập thất bại với mật khẩu sai
    ...
    - list [ref=e46]:
      ...
      - listitem [ref=e62]:
        - link "Liên Hệ" [ref=e63] [cursor=pointer]:
          - /url: /Home/Lien_he
  - generic [ref=e72]:
    - heading "Đăng nhập" [level=1] [ref=e73]
    - generic [ref=e76]:
      - group [ref=e77]:
        - textbox "Tên đăng nhập" [ref=e78]: admin
      - group [ref=e79]:
        - textbox "Mật khẩu" [active] [ref=e80]: WrongPassword123
      - generic [ref=e81]:
      ...
      - generic:
        - generic:
          ...
          - link "Đăng ký tại đây" [ref=e85] [cursor=pointer]:
            - /url: /Account/Dang_ky
  - contentinfo [ref=e86]:
    - generic [ref=e89]:
      - generic [ref=e90]:
        - link "Góc Hoa Xinh" [ref=e92] [cursor=pointer]:
          - /url: /
        ...
        - list [ref=e103]:
          ...
          - listitem [ref=e106]:
            - link "Tất cả sản phẩm" [ref=e107] [cursor=pointer]:
              - /url: /SanPham/tat_ca_san_pham
          - listitem [ref=e108]:
            - link "Bó Hoa Tươi" [ref=e109] [cursor=pointer]:
              - /url: /SanPham/bo_hoa_tuoi
          - listitem [ref=e110]:
            - link "Kệ Hoa chúc mừng" [ref=e111] [cursor=pointer]:
              - /url: /SanPham/ke_hoa_chuc_mung
          - listitem [ref=e112]:
            - link "Hoa Cưới" [ref=e113] [cursor=pointer]:
              - /url: /SanPham/hoa_cuoi
          - listitem [ref=e114]:
            - link "Hoa Sáp" [ref=e115] [cursor=pointer]:
              - /url: /SanPham/hoa_sap
          - listitem [ref=e116]:
      ...
      - generic [ref=e120]:
        ...
        - list [ref=e122]:
          - listitem [ref=e123]:
            - link "Hình Thức Thanh Toán" [ref=e124] [cursor=pointer]:
              - /url: /Chinh_Sach_/Hinh_thuc_thanh_toan
          - listitem [ref=e125]:
            - link "Chính sách giao hàng" [ref=e126] [cursor=pointer]:
              - /url: /Chinh_Sach_/Giao_hang
          - listitem [ref=e127]:
            - link "Chính sách bảo mật thông tin" [ref=e128] [cursor=pointer]:
              - /url: /Chinh_Sach_/Bao_mat
          - listitem [ref=e129]:
            - link "Chính sách bảo hành" [ref=e130] [cursor=pointer]:
              - /url: /Chinh_Sach_/Bao_hanh
          - listitem [ref=e131]:
            - link "Điều khoản sử dụng" [ref=e132] [cursor=pointer]:
    ...
    - link "Lên đầu trang" [ref=e146] [cursor=pointer]:
      - /url: "#"
```
