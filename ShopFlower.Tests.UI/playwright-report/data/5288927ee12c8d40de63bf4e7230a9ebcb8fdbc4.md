...
Expected pattern: /\/Account\/Dang_nhap/
Received string:  "https://localhost:44357/Account/Dang_ky"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × unexpected value "https://localhost:44357/Account/Dang_ky"
...
- group:
  - textbox "Tên đăng nhập": auto_client_1780239523130
- group:
  - textbox "Email": autoclient_1780239523130@example.com
- group:
  - textbox "Tên hiển thị (không bắt buộc)": Khách hàng Tự động
- group:
  - textbox "Mật khẩu": SecurePass123!
- group:
  - textbox "Xác nhận mật khẩu": SecurePass123!
- button "ĐĂNG KÝ"
